...
{
    /// <inheritdoc />
    public partial class livecoaching : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_LiveCoachingCoaches", x => x.Id);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_LiveCoachingCoachDetails", x => x.Id);
                    table.ForeignKey(
                        name: "FK_LiveCoachingCoachDetails_LiveCoachingCoaches_CoachId",
                        column: x => x.CoachId,
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_LiveCoachingSkills", x => x.Id);
                    table.ForeignKey(
                        name: "FK_LiveCoachingSkills_LiveCoachingCoaches_CoachId",
                        column: x => x.CoachId,
                        principalTable: "LiveCoachingCoaches",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_LiveCoachingCoachDetails_CoachId",
                table: "LiveCoachingCoachDetails",
                column: "CoachId",
                unique: true);

            migrationBuilder.CreateIndex(
                name: "IX_LiveCoachingSkills_CoachId",
                table: "LiveCoachingSkills",
                column: "CoachId");
        }
