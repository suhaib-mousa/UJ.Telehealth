...
namespace Telehealth.Migrations
{
    ...
    [Migration("20240517184808_addmakred")]
    partial class addmakred
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("DevNAS.CmsKit.MarkedEntities.MarkedEntity", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                    ...
                    b.HasIndex("TenantId", "MarkedType", "EntityId");

                    b.HasIndex("TenantId", "CreatorId", "MarkedType", "EntityId");

                    b.ToTable("CmsKitMarkedEntities", (string)null);
                });

            modelBuilder.Entity("DevNAS.LiveCoaching.Checkouts.CheckoutRequest", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.ToTable("LiveCoachingCheckoutRequests", (string)null);
                });

            modelBuilder.Entity("DevNAS.LiveCoaching.Coaches.Coach", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.ToTable("LiveCoachingCoaches", (string)null);
                });

            modelBuilder.Entity("DevNAS.LiveCoaching.Coaches.CoachDetails.CoachDetail", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.ToTable("LiveCoachingCoachDetails", (string)null);
                });

            modelBuilder.Entity("DevNAS.LiveCoaching.ReservationManagement.Reservations.Members.ReservationMember", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.ToTable("ReservationManagementReservationMembers", (string)null);
                });

            modelBuilder.Entity("DevNAS.LiveCoaching.ReservationManagement.Reservations.Reservation", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.ToTable("ReservationManagementReservations", (string)null);
                });

            modelBuilder.Entity("DevNAS.LiveCoaching.ReservationManagement.Resources.Resource", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.ToTable("ReservationManagementResources", (string)null);
                });

            modelBuilder.Entity("DevNAS.LiveCoaching.ReservationManagement.Resources.Schedules.ResourceSchedule", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.ToTable("ReservationManagementResourceSchedules", (string)null);
                });

            modelBuilder.Entity("DevNAS.LiveCoaching.Skills.Skill", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.ToTable("LiveCoachingSkills", (string)null);
                });

            modelBuilder.Entity("Telehealth.Skills.MainSkill", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.ToTable("AppMainSkills", (string)null);
                });

            modelBuilder.Entity("Telehealth.Skills.SubSkill", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.ToTable("AppSubSkills", (string)null);
                });
            ...
            modelBuilder.Entity("DevNAS.LiveCoaching.Checkouts.CheckoutRequest", b =>
                {
                    b.HasOne("DevNAS.LiveCoaching.Coaches.Coach", "Coach")
                        .WithMany()
                        .HasForeignKey("CoachId")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired();

                    b.HasOne("DevNAS.LiveCoaching.Skills.Skill", "Skill")
                        .WithMany()
            ...
            modelBuilder.Entity("DevNAS.LiveCoaching.Coaches.CoachDetails.CoachDetail", b =>
                {
                    b.HasOne("DevNAS.LiveCoaching.Coaches.Coach", "Coach")
                        .WithOne("CoachDetail")
                        .HasForeignKey("DevNAS.LiveCoaching.Coaches.CoachDetails.CoachDetail", "CoachId")
            ...
            modelBuilder.Entity("DevNAS.LiveCoaching.ReservationManagement.Reservations.Members.ReservationMember", b =>
                {
                    b.HasOne("DevNAS.LiveCoaching.ReservationManagement.Reservations.Reservation", "Reservation")
                        .WithMany("Members")
            ...
            modelBuilder.Entity("DevNAS.LiveCoaching.ReservationManagement.Reservations.Reservation", b =>
                {
                    b.HasOne("DevNAS.LiveCoaching.ReservationManagement.Resources.Resource", "Resource")
            ...
            modelBuilder.Entity("DevNAS.LiveCoaching.ReservationManagement.Resources.Schedules.ResourceSchedule", b =>
                {
                    b.HasOne("DevNAS.LiveCoaching.ReservationManagement.Resources.Resource", "Resource")
                        .WithOne("Schedule")
                        .HasForeignKey("DevNAS.LiveCoaching.ReservationManagement.Resources.Schedules.ResourceSchedule", "ResourceId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.OwnsOne("DevNAS.LiveCoaching.ReservationManagement.Resources.Schedules.Settings.ResourceScheduleSettings", "ResourceScheduleSettings", b1 =>
                        {
                            b1.Property<Guid>("ResourceScheduleId")
                                .HasColumnType("uniqueidentifier");

                            b1.Property<string>("ExceptionDaysInJson")
                                .HasColumnType("nvarchar(max)");

                            b1.Property<string>("PeriodsInJson")
                                .HasColumnType("nvarchar(max)");

                            b1.HasKey("ResourceScheduleId");

                            b1.ToTable("ReservationManagementResourceSchedules");
                    ...
                    b.Navigation("ResourceScheduleSettings")
                        .IsRequired();
                });
