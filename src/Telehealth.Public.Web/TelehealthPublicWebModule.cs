...
using Telehealth.Public.Web.HealthChecks;
using Telehealth.Public.Web.Menus;
...
[DependsOn(
    ...
    typeof(LiveCoachingPublicWebModule)
    )]
[DependsOn(typeof(BunnyStorageModule))]
[DependsOn(typeof(LiveMeetingsBigBlueButtonWebModule))]
public partial class TelehealthPublicWebModule : AbpModule
{
    public override void PreConfigureServices(ServiceConfigurationContext context)
    {
        ...
        context.Services.PreConfigure<AbpMvcDataAnnotationsLocalizationOptions>(options =>
        {
            options.AddAssemblyResource(
                ...
                typeof(TelehealthPublicWebModule).Assembly
            );
        });
    ...
    private void ConfigureBundles()
    {
        Configure<AbpBundlingOptions>(options =>
        {
            ...
            options
            .StyleBundles
            .Add(TelehealthThemeBundles.Styles.Global, bundle =>
            {
                bundle
                    .AddBaseBundles(StandardBundles.Styles.Global)
                    .AddContributors(typeof(TelehealthGlobalStyleContributer));
            });

            options
            .ScriptBundles
            .Add(TelehealthThemeBundles.Scripts.Global, bundle =>
            {
                bundle
                    .AddBaseBundles(StandardBundles.Scripts.Global)
                    .AddContributors(typeof(TelehealthGlobalScriptContributer));
            });
        });
    }
    ...
    private void ConfigureAutoMapper()
    {
        ...
        {
            options.AddMaps<TelehealthPublicWebModule>();
        });
    }
    ...
    private void ConfigureVirtualFileSystem(IWebHostEnvironment hostingEnvironment)
    {
        ...
        {
            options.FileSets.AddEmbedded<TelehealthPublicWebModule>();
            ...
            if (hostingEnvironment.IsDevelopment())
            {
                ...
                options.FileSets.ReplaceEmbeddedByPhysical<TelehealthPublicWebModule>(hostingEnvironment.ContentRootPath);
            }
        });
    }
    ...
    private void ConfigureNavigationServices()
    {
        ...
        {
            options.MenuContributors.Add(new TelehealthPublicMenuContributor());
        });

        Configure<AbpToolbarOptions>(options =>
        {
            options.Contributors.Add(new TelehealthPublicToolbarContributor());
        });
    }
