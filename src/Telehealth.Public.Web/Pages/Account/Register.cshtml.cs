...
namespace Telehealth.Public.Web.Pages.Account;

public class RegisterModel : Volo.Abp.Account.Public.Web.Pages.Account.AccountPageModel
{
    ...
    protected virtual async Task RegisterLocalUserAsync()
    {
        ...
        _abpIdentityUser.Name = Input.Name;
        _abpIdentityUser.Surname = Input.Surname;
        await UserManager.UpdateAsync(_abpIdentityUser);
